...
export default async function DashboardHome() {
  ...
  return (
    <div className="space-y-8 pb-24 relative max-w-4xl mx-auto px-0">
      ...
      <div className="relative z-20 min-h-[calc(100dvh-7.2rem)] lg:min-h-0 flex items-center justify-center lg:block">
         <DailyMatchCard
           matches={matches}
