      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-16 items-start justify-items-center">
          ...
          <div className="space-y-6 w-full max-w-sm">
            ...
            <p className="text-sm text-slate-400 mb-4">Premier essai d&apos;une carte Offre gamifiée avec CTA intéressé/pas intéressé et ouverture WhatsApp.</p>
            <OfferTinderCardPreview />
          </div>
