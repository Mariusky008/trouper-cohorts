  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#172554_0%,#0f172a_48%,#090b16_100%)] text-white">
      <div className="mx-auto w-full max-w-6xl space-y-8 px-4 pb-24 pt-10 sm:px-6 lg:px-8">
        <section className="grid items-start gap-6 rounded-3xl border border-white/15 bg-white/5 p-6 shadow-[0_24px_80px_-36px_rgba(16,185,129,0.6)] lg:grid-cols-[1.05fr_0.95fr] sm:p-8">
          <div>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <span className="rounded-full border border-white/25 bg-white/10 px-3 py-1 text-xs font-black">💙 Pour toi</span>
              <span className="rounded-full border border-white/25 bg-white/10 px-3 py-1 text-xs font-black">🔥 Opportunites</span>
              <span className="rounded-full border border-white/25 bg-white/10 px-3 py-1 text-xs font-black">💸 Commission</span>
              <span className="rounded-full border border-white/25 bg-white/10 px-3 py-1 text-xs font-black">🤝 Reseau actif</span>
            </div>
          ...
          <div id="hero-demo" className="w-full lg:pl-2">
            ...
            {!heroVideoError ? (
              ...
              <div className="mt-3 space-y-2 rounded-2xl border border-white/10 bg-black/20 p-3 font-mono text-[11px]">
            ...
            <p className="mt-2 text-center text-[10px] text-white/65 lg:text-left">
              Video source: <span className="font-black text-cyan-100">/public/app.mp4</span>
            </p>
          </div>
        </section>
