...
export const metadata: Metadata = {
  ...
  description: `Les règles d'utilisation du site ${MARQUE} et les conditions de vente des options.`,
  ...
  return (
    <article className="prose prose-slate prose-lg max-w-none prose-headings:font-black prose-headings:tracking-tight prose-headings:text-slate-900 prose-p:text-slate-600 prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline prose-strong:text-slate-900 prose-li:text-slate-600">
      ...
      <ul>
        ...
        <li>L'intégration à des groupes de travail (cohortes).</li>
        <li>L'accès à des outils pédagogiques et des ressources numériques.</li>
        <li>La mise en relation avec d'autres membres (système de binômes).</li>
      </ul>

      <h2>3. Inscription et Accès</h2>
      <p>
        L'inscription aux programmes se fait via le Site. Certaines formations peuvent être soumises à une sélection ou à un entretien préalable.
        L'accès à la plateforme est personnel, incessible et sécurisé par un identifiant et un mot de passe. Vous êtes responsable de la confidentialité de vos accès.
      </p>
      ...
      <p>
        Le paiement est exigible immédiatement à la commande. Le règlement s'effectue par carte bancaire via notre prestataire de paiement sécurisé (Stripe).
      </p>

      <h2>5. Droit de Rétractation</h2>
      <p>
        Conformément aux articles L.221-18 et suivants du Code de la consommation, vous disposez d'un délai de 14 jours à compter de la conclusion du contrat pour exercer votre droit de rétractation, sans avoir à motiver votre décision.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>Ne pas tenir de propos discriminatoires, haineux ou offensants.</li>
        <li>Respecter la confidentialité des échanges au sein des groupes privés.</li>
        <li>Participer activement et de manière constructive.</li>
      </ul>
      <p>
        Tout manquement grave à ces règles pourra entraîner l'exclusion définitive de la formation, sans remboursement.
      </p>
      ...
      <p>
        Vos données sont collectées et traitées conformément à notre <a href="/legal/privacy">Politique de Confidentialité</a>.
      </p>

      <h2>10. Loi Applicable et Juridiction</h2>
      <p>
        Les présentes CGU/CGV sont soumises au droit français. En cas de litige, et à défaut d'accord amiable, les tribunaux de Paris (France) seront seuls compétents.
      </p>
