    ...
    <div className="relative w-full max-w-sm mx-auto min-h-[600px] h-auto rounded-[2.5rem] overflow-hidden shadow-2xl bg-[#0f0f12] border border-indigo-500/20 flex flex-col items-center justify-between text-center p-6 pb-8 group">
      ...
      <div className="relative z-10 w-full flex flex-col items-center h-full pt-4">
        ...
        <div className="mb-4 flex flex-col items-center gap-2">
            ...
            <Button variant="outline" className="h-7 text-[10px] px-3 bg-indigo-500/10 border-indigo-500/30 text-indigo-300 hover:bg-indigo-500/20 hover:text-indigo-200 rounded-full uppercase font-bold tracking-wider transition-all hover:scale-105">
        ...
        <div className="grid grid-cols-2 gap-3 w-full mb-auto">
            ...
            <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-3 text-left">
                <div className="flex items-center gap-1.5 mb-2">
                    ...
                    <span className="text-[9px] font-black text-purple-300 uppercase tracking-wider">Son Objectif</span>
                </div>
